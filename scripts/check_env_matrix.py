...
KEYS = {
    ...
    "AUTH_JWT_PRIVATE_KEY": {"readers": [("catalog", "internal/catalog/token.go"), ("auth", "internal/store/token.go")], "default": "账号服务：空 → 进程内临时密钥（重启旧令牌失效）", "safe": True, "note": "审计 arch#16：空值只打一行日志，属于账号侧待改，不在本批"},
