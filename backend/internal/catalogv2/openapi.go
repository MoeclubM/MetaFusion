...
func OpenAPI() map[string]any {
	...
	for _, r := range [][6]string{
		...
		{"/auth/login", "post", "Sign in; return token and HttpOnly cookie", "Credentials", "Result", ""}, {"/auth/me", "get", "Current account", "", "User", "auth"}, {"/auth/logout", "post", "Revoke current session", "", "Result", "auth"}, {"/admin/users", "post", "Create editor (administrator only)", "Credentials", "User", "auth"}, {"/oauth/clients", "get", "List registered OAuth 2.0 clients", "", "Result", ""}, {"/oauth/authorize", "get", "OAuth 2.0 authorization endpoint", "", "Result", ""}, {"/oauth/token", "post", "OAuth 2.0 token endpoint", "", "Result", ""}, {"/oauth/userinfo", "get", "OAuth 2.0 / OIDC user info endpoint", "", "Result", "auth"},
		{"/catalog/definitions", "get", "Published dynamic definitions", "", "DefinitionVersion", ""}, {"/catalog/entities", "get", "Basic PostgreSQL search", "", "Result", ""}, {"/catalog/entities", "post", "Create entity with evidence", "Edit", "Entity", "auth"},
