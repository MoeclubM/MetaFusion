...
// CanonicalEntryPreview 是独立于发行的作品篇目；外部篇目 ID 用于同一作品内去重。
type CanonicalEntryPreview struct {
	Title            string       `json:"title"`
	Position         int          `json:"position"`
...
type PreviewResponse struct {
	...
	CanonicalEntries []CanonicalEntryPreview `json:"canonical_entries,omitempty"`
