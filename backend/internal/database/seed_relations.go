...
func seedRelationTypes(db *gorm.DB) {
	rows := []models.RelationType{
		{Code: "revision_of", Domain: "expression_expression", NameZh: "修订版本", NameEn: "Revision of", Names: models.JSONB{"zh-CN": "修订版本", "en-US": "Revision of"}, ForwardLabelZh: "修订自", ReverseLabelZh: "具有修订版本", ForwardLabelEn: "is revision of", ReverseLabelEn: "has revision", AllowedSourceTypes: pq.StringArray{"canonical_entry"}, AllowedTargetTypes: pq.StringArray{"canonical_entry"}, IsHierarchical: true, Color: "sky", Icon: "GitBranch", SortOrder: 360, IsSystem: true, IsEnabled: true},
		{Code: "translation_of", Domain: "expression_expression", NameZh: "翻译版本", NameEn: "Translation of", Names: models.JSONB{"zh-CN": "翻译版本", "en-US": "Translation of"}, ForwardLabelZh: "翻译自", ReverseLabelZh: "具有翻译版本", ForwardLabelEn: "is translation of", ReverseLabelEn: "has translation", AllowedSourceTypes: pq.StringArray{"canonical_entry"}, AllowedTargetTypes: pq.StringArray{"canonical_entry"}, IsHierarchical: true, Color: "sky", Icon: "GitBranch", SortOrder: 361, IsSystem: true, IsEnabled: true},
...
func seedExternalDatabaseDefinitions(db *gorm.DB) {
	defs := []models.ExternalDatabaseDefinition{
		...
		{
			Code: "bangumi_person", NameZh: "Bangumi 人物", NameEn: "Bangumi Person",
			Names:    models.JSONB{"zh-CN": "Bangumi 人物", "en-US": "Bangumi Person"},
			Category: "artist", URLPattern: "https://bgm.tv/person/{id}",
			Icon: "User", ValidationRegex: `^\d+$`,
			Description: "Bangumi 创作者与演职员人物条目",
			SortOrder:   210, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "bangumi_character", NameZh: "Bangumi 角色", NameEn: "Bangumi Character",
			Names:    models.JSONB{"zh-CN": "Bangumi 角色", "en-US": "Bangumi Character"},
			Category: "artist", URLPattern: "https://bgm.tv/character/{id}",
			Icon: "Smile", ValidationRegex: `^\d+$`,
			Description: "Bangumi 虚拟角色条目",
			SortOrder:   220, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "myanimelist", NameZh: "MyAnimeList", NameEn: "MyAnimeList",
			Names:    models.JSONB{"zh-CN": "MyAnimeList", "en-US": "MyAnimeList"},
			Category: "work", URLPattern: "https://myanimelist.net/anime/{id}",
			Icon: "Tv", ValidationRegex: `^\d+$`,
			Description: "全球动画与漫画数据库 (MAL ID)",
			SortOrder:   230, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "mal_person", NameZh: "MyAnimeList 影人", NameEn: "MyAnimeList Person",
			Names:    models.JSONB{"zh-CN": "MyAnimeList 影人", "en-US": "MyAnimeList Person"},
			Category: "artist", URLPattern: "https://myanimelist.net/people/{id}",
			Icon: "User", ValidationRegex: `^\d+$`,
			Description: "MyAnimeList 创作者/声优档案",
			SortOrder:   240, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "mal_character", NameZh: "MyAnimeList 角色", NameEn: "MyAnimeList Character",
			Names:    models.JSONB{"zh-CN": "MyAnimeList 角色", "en-US": "MyAnimeList Character"},
			Category: "artist", URLPattern: "https://myanimelist.net/character/{id}",
			Icon: "Smile", ValidationRegex: `^\d+$`,
			Description: "MyAnimeList 角色档案",
			SortOrder:   250, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "tmdb_person", NameZh: "TMDB 影人", NameEn: "TMDB Person",
			Names:    models.JSONB{"zh-CN": "TMDB 影人", "en-US": "TMDB Person"},
			Category: "artist", URLPattern: "https://www.themoviedb.org/person/{id}",
			Icon: "User", ValidationRegex: `^\d+$`,
			Description: "The Movie Database 演职员条目",
			SortOrder:   260, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "imdb_person", NameZh: "IMDb 影人", NameEn: "IMDb Person",
			Names:    models.JSONB{"zh-CN": "IMDb 影人", "en-US": "IMDb Person"},
			Category: "artist", URLPattern: "https://www.imdb.com/name/{id}/",
			Icon: "User", ValidationRegex: `^nm\d+$`,
			Description: "IMDb 影人档案 (如 nm0000001)",
			SortOrder:   270, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "vndb_character", NameZh: "VNDB 角色", NameEn: "VNDB Character",
			Names:    models.JSONB{"zh-CN": "VNDB 角色", "en-US": "VNDB Character"},
			Category: "artist", URLPattern: "https://vndb.org/c{id}",
			Icon: "Smile", ValidationRegex: `^c?\d+$`,
			Description: "VNDB 视觉小说角色档案",
			SortOrder:   280, IsEnabled: true, IsSystem: true,
		},
		{
			Code: "vndb_staff", NameZh: "VNDB 职员", NameEn: "VNDB Staff",
			Names:    models.JSONB{"zh-CN": "VNDB 职员", "en-US": "VNDB Staff"},
			Category: "artist", URLPattern: "https://vndb.org/s{id}",
			Icon: "User", ValidationRegex: `^s?\d+$`,
			Description: "VNDB 制作人员档案",
			SortOrder:   290, IsEnabled: true, IsSystem: true,
		},
	}
...
func seedAttributeSchemas(db *gorm.DB) {
	schemas := []models.EntityAttributeSchema{
		...
		// ── Artists (创作者动态属性：仅保留非实体关系的固有纯属性，事务所/团队隶属一律通过 member_of 边建立) ──
		{
			EntityType:   "artist",
...
func seedEntityTypeDefinitions(db *gorm.DB) {
	defs := []models.EntityTypeDefinition{
		...
		},
		{
			...
			Names:  models.JSONB{"zh-CN": "角色 / 人物", "en-US": "Character", "ja": "キャラクター"},
			DescZh: "动漫、游戏、影视等作品中的登场角色与人物形象（含 Vtuber、虚拟企划人物）",
			DescEn: "Fictional characters in anime, games, film and other works (incl. VTubers and franchise personas).",
