...
('deadbeef-0000-4000-8000-000000000001', '刀剑神域', 'ソードアート・オンライン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000001.jpg',
...
('deadbeef-0000-4000-8000-000000000002', '葬送的芙莉莲', '葬送のフリーレン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000002.jpg',
...
('deadbeef-0000-4000-8000-000000000003', '孤独摇滚！', 'ぼっち・ざ・ろっく！',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000003.jpg',
...
('deadbeef-0000-4000-8000-000000000004', '紫罗兰永恒花园', 'ヴァイオレット・エヴァーガーデン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000004.jpg',
...
('deadbeef-0000-4000-8000-000000000005', 'Re:从零开始的异世界生活', 'Re:ゼロから始める異世界生活',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000005.jpg',
...
('deadbeef-0000-4000-8000-000000000006', '进击的巨人', '進撃の巨人',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000006.jpg',
...
('deadbeef-0000-4000-8000-000000000101', '', '刀剑神域', 'ソードアート・オンライン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000101.jpg', '3:4', 'completed', '00000000-0000-0000-0000-000000000001', '{"volumes":28,"label":"電撃文庫","format":"light_novel"}'),
...
('deadbeef-0000-4000-8000-000000000102', '', '刀剑神域', 'ソードアート・オンライン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000102.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"episodes":25,"director":"伊藤智彦","format":"tv_anime","season":1}'),
...
('deadbeef-0000-4000-8000-000000000103', '', '刀剑神域：序列之争', '劇場版 ソードアート・オンライン -オーディナル・スケール-',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000103.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"duration_mins":119,"box_office_jpy":"4.3B"}'),
...
('deadbeef-0000-4000-8000-000000000104', '', 'Sword Art Online Music Collection', 'Sword Art Online Music Collection',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000104.jpg', '1:1', 'completed', '00000000-0000-0000-0000-000000000001', '{"discs":4,"tracks":131,"catalog":"SVWC-70116"}'),
...
('deadbeef-0000-4000-8000-000000000105', '', '葬送的芙莉莲', '葬送のフリーレン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000105.jpg', '3:4', 'completed', '00000000-0000-0000-0000-000000000001', '{"magazine":"周刊少年Sunday","format":"manga"}'),
...
('deadbeef-0000-4000-8000-000000000106', '', '葬送的芙莉莲', '葬送のフリーレン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000106.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"episodes":28,"director":"斎藤圭一郎","format":"tv_anime","season":1}'),
...
('deadbeef-0000-4000-8000-000000000107', '', 'TV 动画「葬送的芙莉莲」Original Soundtrack', 'TVアニメ『葬送のフリーレン』Original Soundtrack',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000107.jpg', '1:1', 'completed', '00000000-0000-0000-0000-000000000001', '{"discs":2,"tracks":70,"catalog":"THCA-60288"}'),
...
('deadbeef-0000-4000-8000-000000000108', '', '孤独摇滚！', 'ぼっち・ざ・ろっく！',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000108.jpg', '3:4', 'completed', '00000000-0000-0000-0000-000000000001', '{"publisher":"芳文社","format":"manga"}'),
...
('deadbeef-0000-4000-8000-000000000109', '', '孤独摇滚！', 'ぼっち・ざ・ろっく！',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000109.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"episodes":12,"director":"斎藤圭一郎","format":"tv_anime","season":1}'),
...
('deadbeef-0000-4000-8000-000000000110', '', '結束バンド', '結束バンド',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000110.jpg', '1:1', 'completed', '00000000-0000-0000-0000-000000000001', '{"tracks":14,"catalog":"SVWC-70613","format":"album"}'),
...
('deadbeef-0000-4000-8000-000000000111', '', '紫罗兰永恒花园', 'ヴァイオレット・エヴァーガーデン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000111.jpg', '3:4', 'completed', '00000000-0000-0000-0000-000000000001', '{"volumes":4,"label":"KAエスマ文庫","format":"light_novel"}'),
...
('deadbeef-0000-4000-8000-000000000112', '', '紫罗兰永恒花园', 'ヴァイオレット・エヴァーガーデン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000112.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"episodes":14,"studio":"京都アニメーション","format":"tv_anime","season":1}'),
...
('deadbeef-0000-4000-8000-000000000113', '', '紫罗兰永恒花园 剧场版', '劇場版 ヴァイオレット・エヴァーガーデン',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000113.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"duration_mins":140,"studio":"京都アニメーション"}'),
...
('deadbeef-0000-4000-8000-000000000114', '', 'VIOLET EVERGARDEN : Automemories', 'VIOLET EVERGARDEN : Automemories',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000114.jpg', '1:1', 'completed', '00000000-0000-0000-0000-000000000001', '{"discs":2,"tracks":47,"catalog":"LACA-9573"}'),
...
('deadbeef-0000-4000-8000-000000000115', '', 'Re:从零开始的异世界生活', 'Re:ゼロから始める異世界生活',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000115.jpg', '3:4', 'completed', '00000000-0000-0000-0000-000000000001', '{"label":"MF文庫J","format":"light_novel"}'),
...
('deadbeef-0000-4000-8000-000000000116', '', 'Re:从零开始的异世界生活', 'Re:ゼロから始める異世界生活',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000116.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"episodes":25,"director":"渡邊政治","format":"tv_anime","season":1}'),
...
('deadbeef-0000-4000-8000-000000000117', '', '进击的巨人', '進撃の巨人',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000117.jpg', '3:4', 'completed', '00000000-0000-0000-0000-000000000001', '{"volumes":34,"chapters":139,"publisher":"講談社","format":"manga"}'),
...
('deadbeef-0000-4000-8000-000000000118', '', '进击的巨人', '進撃の巨人 Season 1',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000118.jpg', '2:3', 'completed', '00000000-0000-0000-0000-000000000001', '{"episodes":25,"director":"荒木哲郎","format":"tv_anime","season":1}'),
...
('deadbeef-0000-4000-8000-000000000119', '', '「進撃の巨人」Original Soundtrack', '「進撃の巨人」Original Soundtrack',
    ...
    '/storage/preview/covers/deadbeef-0000-4000-8000-000000000119.jpg', '1:1', 'completed', '00000000-0000-0000-0000-000000000001', '{"tracks":16,"catalog":"PCCG-01351"}')
ON CONFLICT (id) DO UPDATE SET
    title = EXCLUDED.title,
    original_title = EXCLUDED.original_title,
    aliases = EXCLUDED.aliases,
