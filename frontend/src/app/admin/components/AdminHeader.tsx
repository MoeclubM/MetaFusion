...
export function AdminHeader({
  ...
  return (
    <header className="h-14 border-b border-white/[0.08] bg-[#0c0c0f]/95 backdrop-blur px-4 flex items-center justify-between sticky top-0 z-40 shrink-0">
      {/* Left: Brand & Breadcrumb */}
      <div className="flex items-center gap-3">
        <Link
          href="/"
          className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-white px-2.5 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.08] transition-all font-mono"
        >
        ...
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-md bg-amber-500/10 border border-amber-500/30 grid place-items-center">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="relative w-40 sm:w-56 md:w-64">
          ...
          <input
            ...
            className="w-full pl-8 pr-7 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.08] text-xs text-white placeholder-gray-500 focus:outline-none focus:border-amber-400/50 transition-colors"
          />
          {searchQuery && (
            <button
        ...
        <button
          ...
          className="w-8 h-8 grid place-items-center rounded-lg bg-white/[0.04] border border-white/[0.08] text-gray-400 hover:text-white hover:bg-white/[0.08] transition-colors"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-8 h-8 grid place-items-center rounded-lg bg-white/[0.04] border border-white/[0.08] text-gray-400 hover:text-rose-400 hover:bg-rose-500/10 hover:border-rose-500/20 transition-colors"
          >
