    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full p-3.5 rounded-lg bg-background border border-black/10 dark:border-white/10 text-gray-900 dark:text-white text-sm leading-relaxed resize-none focus:outline-none focus:border-primary"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full p-3.5 rounded-lg bg-background border border-black/10 dark:border-white/10 text-gray-900 dark:text-white font-mono text-sm leading-relaxed resize-none focus:outline-none focus:border-primary"
        />
      </div>
    </div>
  );
