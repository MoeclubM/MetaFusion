    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <label className="block text-xs sm:text-sm font-mono text-gray-300">{t("editor.external.mbidLabel")}</label>
          <input
            type="text"
        ...
        <div className="space-y-1.5">
          <label className="block text-xs sm:text-sm font-mono text-gray-300">{t("editor.external.bangumiLabel")}</label>
          <input
            type="text"
        ...
        <div className="space-y-1.5">
          <label className="block text-xs sm:text-sm font-mono text-gray-300">{t("editor.external.imdbLabel")}</label>
          <input
            type="text"
        ...
        <div className="space-y-1.5">
          <label className="block text-xs sm:text-sm font-mono text-gray-300">{t("editor.external.vndbLabel")}</label>
          <input
            type="text"
