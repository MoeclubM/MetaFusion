...
WORKS = [
    ...
    (1, "诡秘之主", "诡秘之主", ["Lord of the Mysteries", "LotM", "克莱恩"], "2018-04-01", "2018-04-01", "2020-05-01", True, "中国", "zh-CN", "zh",
     ...
     [
         (1, "诡秘之主（起点中文网正版连载·完结典藏版）", "QD-LOTM-2018", "", 47, "起点中文网 / 阅文集团", "digital", "2018-04-01", "CN", "zh-CN", "digital", "起点中文网官方首发连载版，全8部1432章。", {"volume_count": 8, "status": "completed"}, [(1, 1, "全八部连载章节", "Digital", "novel", 0)]),
         (2, "诡秘之主 1：小丑（精装典藏版，江苏凤凰文艺出版社，ISBN 9787559451231）", "978-7-5594-5123-1", "9787559451231", 47, "江苏凤凰文艺出版社 / 阅文图书", "hardcover", "2020-09-01", "CN", "zh-CN", "retail", "精装典藏版，全彩插画与克莱恩塔罗牌附赠。", {"isbn": "9787559451231", "volume": 1}, [(2, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (2, "全职高手", "全职高手", ["The King's Avatar", "荣耀", "叶修", "蝴蝶蓝全职"], "2011-02-28", "2011-02-28", "2014-04-28", True, "中国", "zh-CN", "zh",
     ...
     [
         (3, "全职高手（起点中文网正版连载·十周年数字典藏版）", "QD-QZGS-2011", "", 47, "起点中文网 / 阅文集团", "digital", "2011-02-28", "CN", "zh-CN", "digital", "起点连载版全1728章。", {"chapters": 1728}, [(3, 1, "全本连载", "Digital", "novel", 0)]),
         (4, "全职高手 1：巅峰荣耀（实体精装典藏版，百花洲文艺出版社，ISBN 9787550018457）", "978-7-5500-1845-7", "9787550018457", 47, "百花洲文艺出版社 / 阅文图书", "paperback", "2016-07-01", "CN", "zh-CN", "retail", "全职高手实体单行本第1卷，收录千机伞与第十区风云。", {"isbn": "9787550018457", "volume": 1}, [(4, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (3, "道诡异仙", "道诡异仙", ["Dao of the Bizarre Immortal", "李火旺", "坐忘道", "狐尾的笔"], "2021-12-16", "2021-12-16", "2023-05-09", True, "中国", "zh-CN", "zh",
     ...
     [
         (5, "道诡异仙（起点中文网官方数字连载版）", "QD-DGYX-2021", "", 47, "起点中文网 / 阅文集团", "digital", "2021-12-16", "CN", "zh-CN", "digital", "连载版，全1024章正文加番外。", {"chapters": 1024}, [(5, 1, "正文连载", "Digital", "novel", 0)]),
         (6, "道诡异仙 1：火旺出山（实体出版典藏版，湖南文艺出版社，ISBN 9787540498894）", "978-7-5404-9889-4", "9787540498894", 47, "湖南文艺出版社 / 阅文图书", "paperback", "2023-11-01", "CN", "zh-CN", "retail", "收录第一卷完整内容与精美民俗插画。", {"isbn": "9787540498894", "volume": 1}, [(6, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (4, "斗罗大陆", "斗罗大陆", ["Soul Land", "Douluo Dalu", "唐三", "唐门"], "2008-12-14", "2008-12-14", "2009-12-13", True, "中国", "zh-CN", "zh",
     ...
     [
         (7, "斗罗大陆（起点中文网官方数字连载版）", "QD-DLDL-2008", "", 47, "起点中文网 / 阅文集团", "digital", "2008-12-14", "CN", "zh-CN", "digital", "起点连载原版。", {"chapters": 336}, [(7, 1, "网络连载全文", "Digital", "novel", 0)]),
         (8, "斗罗大陆 1（实体初版单行本，湖南少年儿童出版社，ISBN 9787535842350）", "978-7-5358-4235-0", "9787535842350", 47, "湖南少年儿童出版社 / 阅文图书", "paperback", "2009-05-01", "CN", "zh-CN", "retail", "斗罗大陆实体初版第1册。", {"isbn": "9787535842350", "volume": 1}, [(8, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (5, "庆余年", "庆余年", ["Joy of Life", "范闲", "庆帝", "陈萍萍"], "2007-05-25", "2007-05-25", "2009-02-28", True, "中国", "zh-CN", "zh",
     ...
     [
         (9, "庆余年（起点中文网正版连载·七卷全本数字版）", "QD-QYN-2007", "", 47, "起点中文网 / 阅文集团", "digital", "2007-05-25", "CN", "zh-CN", "digital", "起点连载完整版全七卷。", {"volumes": 7}, [(9, 1, "连载全文", "Digital", "novel", 0)]),
         (10, "庆余年 1：远来是客（典藏精装版，人民文学出版社，ISBN 9787020158812）", "978-7-02-015881-2", "9787020158812", 47, "人民文学出版社 / 阅文图书", "hardcover", "2020-01-01", "CN", "zh-CN", "retail", "人民文学出版社精装典藏版。", {"isbn": "9787020158812", "volume": 1}, [(10, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (6, "大奉打更人", "大奉打更人", ["Nightwatcher of Dafeng", "许七安", "打更人", "卖报小郎君"], "2020-05-18", "2020-05-18", "2021-08-11", True, "中国", "zh-CN", "zh",
     ...
     [
         (11, "大奉打更人（起点中文网官方数字连载版）", "QD-DFDGR-2020", "", 47, "起点中文网 / 阅文集团", "digital", "2020-05-18", "CN", "zh-CN", "digital", "起点连载版。", {"chapters": 809}, [(11, 1, "正文", "Digital", "novel", 0)]),
         (12, "大奉打更人 1：税银案（实体图书单行本，北京联合出版公司，ISBN 9787559653888）", "978-7-5596-5388-8", "9787559653888", 47, "北京联合出版公司 / 阅文图书", "paperback", "2021-12-01", "CN", "zh-CN", "retail", "实体单行本第1卷，收录税银奇案与桑泊大案。", {"isbn": "9787559653888", "volume": 1}, [(12, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (7, "凡人修仙传", "凡人修仙传", ["A Record of a Mortal's Journey to Immortality", "韩立", "韩跑跑", "忘语"], "2008-02-20", "2008-02-20", "2013-09-23", True, "中国", "zh-CN", "zh",
     ...
     [
         (13, "凡人修仙传（起点中文网官方连载版·人界与灵界篇）", "QD-FRXXZ-2008", "", 47, "起点中文网 / 阅文集团", "digital", "2008-02-20", "CN", "zh-CN", "digital", "起点连载人界篇与灵界篇全本。", {"chapters": 2451}, [(13, 1, "人界与灵界篇", "Digital", "novel", 0)]),
         (14, "凡人修仙传 1：七玄风云（实体单行本，湖南文艺出版社，ISBN 9787540445300）", "978-7-5404-4530-0", "9787540445300", 47, "湖南文艺出版社 / 阅文图书", "paperback", "2010-04-01", "CN", "zh-CN", "retail", "韩立拜入七玄门与结识墨大夫篇章。", {"isbn": "9787540445300", "volume": 1}, [(14, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (8, "遮天", "遮天", ["Shrouding the Heavens", "叶凡", "九龙拉棺", "辰东"], "2010-10-14", "2010-10-14", "2013-05-21", True, "中国", "zh-CN", "zh",
     ...
     [
         (15, "遮天（起点中文网正版连载·全本数字版）", "QD-ZT-2010", "", 47, "起点中文网 / 阅文集团", "digital", "2010-10-14", "CN", "zh-CN", "digital", "连载版全本。", {"chapters": 1822}, [(15, 1, "全书章节", "Digital", "novel", 0)]),
         (16, "遮天 1：九龙拉棺（实体典藏版，长江出版社，ISBN 9787549206902）", "978-7-5492-0690-2", "9787549206902", 47, "长江出版社 / 阅文图书", "paperback", "2011-06-01", "CN", "zh-CN", "retail", "泰山之巅九龙拉棺初遇篇章。", {"isbn": "9787549206902", "volume": 1}, [(16, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (9, "完美世界", "完美世界", ["Perfect World", "石昊", "荒天帝", "辰东完美世界"], "2013-08-16", "2013-08-16", "2016-08-04", True, "中国", "zh-CN", "zh",
     ...
     [
         (17, "完美世界（起点中文网官方数字连载版）", "QD-WMSJ-2013", "", 47, "起点中文网 / 阅文集团", "digital", "2013-08-16", "CN", "zh-CN", "digital", "起点首发连载版。", {"chapters": 2014}, [(17, 1, "正文连载", "Digital", "novel", 0)]),
         (18, "完美世界 1：大荒幼童（实体图书，京华出版社，ISBN 9787550223097）", "978-7-5502-2309-7", "9787550223097", 47, "京华出版社 / 阅文图书", "paperback", "2014-01-01", "CN", "zh-CN", "retail", "石村幼童石昊成长初卷。", {"isbn": "9787550223097", "volume": 1}, [(18, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (10, "雪中悍刀行", "雪中悍刀行", ["The Snowy Path of the Heroic Blade", "徐凤年", "北椋", "烽火戏诸侯"], "2012-04-10", "2012-04-10", "2016-08-07", True, "中国", "zh-CN", "zh",
     ...
     [
         (19, "雪中悍刀行（纵横中文网官方连载·全本数字版）", "ZH-XZHDX-2012", "", None, "纵横中文网", "digital", "2012-04-10", "CN", "zh-CN", "digital", "纵横首发网络版。", {"chapters": 1002}, [(19, 1, "连载全文", "Digital", "novel", 0)]),
         (20, "雪中悍刀行 1：老魁出水（实体典藏版，湖南文艺出版社，ISBN 9787540459390）", "978-7-5404-5939-0", "9787540459390", None, "湖南文艺出版社", "paperback", "2013-05-01", "CN", "zh-CN", "retail", "老黄与世子游历江湖篇章。", {"isbn": "9787540459390", "volume": 1}, [(20, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (11, "剑来", "剑来", ["Sword Dynasty", "陈平安", "落魄山", "文圣一脉"], "2017-06-01", "2017-06-01", "", False, "中国", "zh-CN", "zh",
     ...
     [
         (21, "剑来（纵横中文网官方数字连载版）", "ZH-JIANLAI-2017", "", None, "纵横中文网", "digital", "2017-06-01", "CN", "zh-CN", "digital", "纵横中文网连载版，突破1100万字。", {"ongoing": True}, [(21, 1, "连载章节", "Digital", "novel", 0)]),
         (22, "剑来 1：陇上泥瓶（实体图书，长江文艺出版社，ISBN 9787535499851）", "978-7-5354-9985-1", "9787535499851", None, "长江文艺出版社", "paperback", "2018-03-01", "CN", "zh-CN", "retail", "骊珠洞天风云篇章。", {"isbn": "9787535499851", "volume": 1}, [(22, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (12, "吞噬星空", "吞噬星空", ["Swallowed Star", "罗峰", "金角巨兽", "我吃西红柿"], "2010-07-21", "2010-07-21", "2012-03-12", True, "中国", "zh-CN", "zh",
     ...
     [
         (23, "吞噬星空（起点中文网官方数字连载版）", "QD-TSXK-2010", "", 47, "起点中文网 / 阅文集团", "digital", "2010-07-21", "CN", "zh-CN", "digital", "起点连载全本。", {"chapters": 1485}, [(23, 1, "正文", "Digital", "novel", 0)]),
         (24, "吞噬星空 1：地球觉醒（实体图书单行本，时代文艺出版社，ISBN 9787538734751）", "978-7-5387-3475-1", "9787538734751", 47, "时代文艺出版社 / 阅文图书", "paperback", "2011-04-01", "CN", "zh-CN", "retail", "地球武者篇章。", {"isbn": "9787538734751", "volume": 1}, [(24, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (13, "宿命之环", "宿命之环", ["Circle of Inevitability", "CoI", "卢米安", "诡秘之主2"], "2023-03-04", "2023-03-04", "", False, "中国", "zh-CN", "zh",
     ...
     [
         (25, "宿命之环（起点中文网官方数字连载版）", "QD-COI-2023", "", 47, "起点中文网 / 阅文集团", "digital", "2023-03-04", "CN", "zh-CN", "digital", "起点中文网官方首发连载版。", {"ongoing": True}, [(25, 1, "正文连载", "Digital", "novel", 0)]),
         (125, "宿命之环 1：宿命之环（初版单行本，新星出版社，ISBN 9787513352887）", "978-7-5133-5288-7", "9787513352887", 47, "新星出版社 / 阅文图书", "paperback", "2023-10-01", "CN", "zh-CN", "retail", "新星出版社与阅文图书联合出版实体第1卷，收录第1部科尔杜村风云。", {"isbn": "9787513352887", "volume": 1}, [(125, 1, "第1部 宿命之环", "Book", "novel", 0)])
     ]),
    ...
    (14, "仙逆", "仙逆", ["Renegade Immortal", "王林", "顺为凡逆则仙", "耳根"], "2009-06-08", "2009-06-08", "2012-01-09", True, "中国", "zh-CN", "zh",
     ...
     [
         (26, "仙逆（起点中文网官方连载·全本数字版）", "QD-XIANNI-2009", "", 47, "起点中文网 / 阅文集团", "digital", "2009-06-08", "CN", "zh-CN", "digital", "起点连载版全本。", {"chapters": 2088}, [(26, 1, "全书正文", "Digital", "novel", 0)]),
         (27, "仙逆 1：恒岳修仙（实体单行本，花山文艺出版社，ISBN 9787807559016）", "978-7-80755-901-6", "9787807559016", 47, "花山文艺出版社 / 阅文图书", "paperback", "2010-09-01", "CN", "zh-CN", "retail", "恒岳派修炼初卷。", {"isbn": "9787807559016", "volume": 1}, [(27, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (15, "斗破苍穹", "斗破苍穹", ["Battle Through the Heavens", "萧炎", "莫欺少年穷", "天蚕土豆"], "2009-04-14", "2009-04-14", "2011-07-20", True, "中国", "zh-CN", "zh",
     ...
     [
         (28, "斗破苍穹（起点中文网官方数字连载版）", "QD-DPCQ-2009", "", 47, "起点中文网 / 阅文集团", "digital", "2009-04-14", "CN", "zh-CN", "digital", "起点连载全本。", {"chapters": 1648}, [(28, 1, "全书正文", "Digital", "novel", 0)]),
         (29, "斗破苍穹 1：废柴少年（实体单行本，湖南少年儿童出版社，ISBN 9787535845603）", "978-7-5358-4560-3", "9787535845603", 47, "湖南少年儿童出版社 / 阅文图书", "paperback", "2009-10-01", "CN", "zh-CN", "retail", "三年之约启程卷。", {"isbn": "9787535845603", "volume": 1}, [(29, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (16, "蛊真人", "蛊真人", ["Reverend Insanity", "古月方源", "春秋蝉", "大爱仙尊"], "2012-12-15", "2012-12-15", "2019-05-01", True, "中国", "zh-CN", "zh",
     ...
     [
         (30, "蛊真人（起点中文网历史连载原版）", "QD-GZR-2012", "", 47, "起点中文网 / 阅文集团", "digital", "2012-12-15", "CN", "zh-CN", "digital", "网络连载完整版全2334章。", {"chapters": 2334}, [(30, 1, "全书正文", "Digital", "novel", 0)])
     ]),
    ...
    (17, "牧神记", "牧神记", ["Tales of Herding Gods", "秦牧", "残老村", "神魔皆道"], "2017-06-06", "2017-06-06", "2019-09-02", True, "中国", "zh-CN", "zh",
     ...
     [
         (31, "牧神记（起点中文网官方数字连载版）", "QD-MSJ-2017", "", 47, "起点中文网 / 阅文集团", "digital", "2017-06-06", "CN", "zh-CN", "digital", "起点连载版。", {"chapters": 1827}, [(31, 1, "全本正文", "Digital", "novel", 0)]),
         (32, "牧神记 1：残老村出大墟（实体图书，北京联合出版公司，ISBN 9787559618900）", "978-7-5596-1890-0", "9787559618900", 47, "北京联合出版公司 / 阅文图书", "paperback", "2018-05-01", "CN", "zh-CN", "retail", "残老村九老授艺初卷。", {"isbn": "9787559618900", "volume": 1}, [(32, 1, "正文", "Book", "novel", 0)])
     ]),
    ...
    (18, "放开那个女巫", "放开那个女巫", ["Release That Witch", "罗兰·温布顿", "女巫种田", "二目"], "2016-03-04", "2016-03-04", "2018-09-02", True, "中国", "zh-CN", "zh",
     ...
     [
         (33, "放开那个女巫（起点中文网官方数字连载版）", "QD-FKNW-2016", "", 47, "起点中文网 / 阅文集团", "digital", "2016-03-04", "CN", "zh-CN", "digital", "起点连载全本。", {"chapters": 1498}, [(33, 1, "正文", "Digital", "novel", 0)]),
         (34, "放开那个女巫 1：边陲之火（实体单行本，江苏凤凰文艺出版社，ISBN 9787559408990）", "978-7-5594-0899-0", "9787559408990", 47, "江苏凤凰文艺出版社 / 阅文图书", "paperback", "2017-08-01", "CN", "zh-CN", "retail", "边陲小镇初兴篇章。", {"isbn": "9787559408990", "volume": 1}, [(34, 1, "正文", "Book", "novel", 0)])
     ]),
